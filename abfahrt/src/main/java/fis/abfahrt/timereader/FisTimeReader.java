package fis.abfahrt.timereader;
...
public class FisTimeReader {

	public void readFisTimeData() {
		/*
		 ...
		 * zeigt alle Abfahrten der nächsten 120 Minuten hd1=1 blendet
		 * dieRichtungsangabe unter dem Haltestellennamen aus
		 */
		try {
